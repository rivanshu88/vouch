...
class VouchStore {
  ...
  public candidateSkills: CandidateSkill[] = [
    ...
    },
    {
      ...
      verifiedAt: "2024-03-05T11:00:00.000Z",
    },
    {
      id: "cs-07",
      candidateId: "usr-02",
      ...
      verifiedAt: "2024-02-18T12:00:00.000Z",
    },
    {
      id: "cs-08",
      candidateId: "usr-02",
      ...
      verificationStatus: "verified",
      verificationScore: 82,
      verifiedAt: "2024-02-21T10:00:00.000Z",
    },
    {
      id: "cs-09",
      candidateId: "usr-02",
  ...
  public projects: Project[] = [
    ...
    },
    {
      id: "prj-03",
      candidateId: "usr-02",
      title: "RollupMesh — Verifiable Cross-Rollup Sequencer",
      description: "Decentralized sequencing network for optimistic and zero-knowledge rollups with sub-second verifiable finality.",
      technologies: ["Python", "Rust", "Solidity", "Docker"],
      githubUrl: "https://github.com/rohank-dev/rollup-mesh",
      projectUrl: "https://rollupmesh.xyz",
      createdAt: "2024-02-10T14:00:00.000Z",
    },
    {
      id: "prj-04",
      candidateId: "usr-04",
      title: "StreamAnomaly — Telemetry Outlier Engine",
      description: "Real-time outlier detection on high-frequency streaming timeseries metrics with sliding-window dynamic thresholding.",
      technologies: ["Python", "Kafka", "PostgreSQL", "Docker"],
      githubUrl: "https://github.com/priyasun/stream-anomaly",
  ...
  public certificates: Certificate[] = [
    ...
    },
    {
      ...
      credentialUrl: "https://blockchain-council.org/verify/rk-9921",
      createdAt: "2024-01-20T10:00:00.000Z",
    },
    {
      id: "cert-03",
      ...
      credentialUrl: "https://cloud.google.com/certification/verify/ps-4412",
      ...
      requirements: [
        {
          ...
          skillId: "solidity",
          skillName: "Solidity",
          role: "Smart Contracts Architect",
  ...
  public joinRequests: TeamJoinRequest[] = [
    {
      ...
      message: "I can contribute high-performance Python microservices and data pipelines for rollup sequencing.",
      status: "pending",
  ...
  public verificationTests: TeamVerificationTest[] = [
    {
      ...
      completedAt: "2024-02-27T10:14:30.000Z",
